                ...
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <form role="form" method="POST" action="{{ route('projectuser.store') }}"
                                  enctype="multipart/form-data" id="formAddUser">
                                @csrf
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-xs-4">
                                        ...
                                        <select class="form-control col-xs-10 @error('department_id') is-invalid @enderror"
